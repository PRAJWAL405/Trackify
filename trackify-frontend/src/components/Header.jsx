export default function Header() {
  return (
    <header className="w-full py-5 px-4 sm:px-6 animate-fade-in-down">
      <div className="max-w-3xl mx-auto flex items-center justify-between">
        {/* Logo & Title */}
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center bg-gradient-to-br from-violet-500 to-cyan-500">
